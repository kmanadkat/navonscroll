function hide_on_scroll(obj) {
  ...
  '.nav-scroll-up{transform: translateY(-' + nav_height + 'px)!important;}' +
  '.nav-scroll-down{transform: translateY(' + nav_height + 'px)!important;}' +
  '.nav-scroll-fixed-'+ nav_position +'{position: fixed;'+ nav_position +': 0;right: 0;left: 0;z-index: 1000;}' +
  '.nav-scroll-transition{will-change: transform; transition: transform 0.5s cubic-bezier(0.5, 0, 0.25, 1), -webkit-transform 0.5s cubic-bezier(0.5, 0, 0.25, 1)!important;}';
